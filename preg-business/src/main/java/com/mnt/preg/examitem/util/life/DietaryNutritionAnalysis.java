 ...
 */
public class DietaryNutritionAnalysis {

    public static final Logger LOGGER = LoggerFactory.getLogger(DietaryNutritionAnalysis.class);
    ...
    protected DietaryFrequencyConstant dietaryFrequencyConstant;
    ...
    public DietaryNutritionAnalysis(List<LifeStyleQuestionAnswerPojo> lifeStyleQuestionAnswerBos,
            List<EvaluateFoodLibraryPojo> evaluateFoodLibraryVos) {
        lifeStyleConstant = LifeStyleConstant.getInstance();
        dietaryFrequencyConstant = DietaryFrequencyConstant.getInstance();
    ...
    public double getOilWeight() {
        double result = 0;
        List<LifeStyleQuestionAnswerPojo> classes4 = questionMap.get(dietaryFrequencyConstant.p904);
        if (CollectionUtils.isNotEmpty(classes4)) {
            for (LifeStyleQuestionAnswerPojo lifeStyleQuestionAnswerBo : classes4) {
                String optionId = lifeStyleQuestionAnswerBo.getOptionId();
                if ("O90401".equals(optionId)) {
                    result = 5;
                }
                if ("O90402".equals(optionId)) {
                    result = 15;
                }
                if ("O90403".equals(optionId)) {
                    result = 25;
                }
                if ("O90404".equals(optionId)) {
                    result = 35;
                }
                if ("O90405".equals(optionId)) {
                    result = 45;
                }
            }
        }
     ...
     * @return 重量
     */
    public String[] getOilWeightString() {
        String[] result = new String[] {"——", ""};
        List<LifeStyleQuestionAnswerPojo> classes4 = questionMap.get(dietaryFrequencyConstant.p904);
        if (CollectionUtils.isNotEmpty(classes4)) {
            for (LifeStyleQuestionAnswerPojo lifeStyleQuestionAnswerBo : classes4) {
                if (dietaryFrequencyConstant.O90401.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                    result = new String[] {"＜10", "↓"};
                }
                if (dietaryFrequencyConstant.O90402.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                    result = new String[] {"10-20", "↓"};
                }
                if (dietaryFrequencyConstant.O90403.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                    result = new String[] {"约25", ""};
                }
                if (dietaryFrequencyConstant.O90404.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                    result = new String[] {"30-40", "↑"};
                }
                if (dietaryFrequencyConstant.O90405.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
    ...
    public double getGoodProtid(String element) {
        ...
        double p801 = getP801GoodP();
        result = result + p801;

        if (resultEntity != null) {
            result = result + resultEntity.getWeight() * resultEntity.getRatio() * elevalm / 100;
        }
     ...
     * @return
     */
    public double getSnacksClassLingShi(String element) {
        double result = 0;
        if (foodLibraryMap == null) {
            throw new ServiceException(ResultCode.ERROR_90001);
        }
     ...
     * @return
     */
    public double getSnacksClassYingyang(String element) {
        double result = 0;
        if (foodLibraryMap == null) {
            throw new ServiceException(ResultCode.ERROR_90001);
        }
            ...
            for (LifeStyleQuestionAnswerPojo lifeStyleQuestionAnswerBo : p901List) {
                if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getOptionId())) {
                    if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getAddvalue())
                        ...
                        if (lifeStyleConstant.O90102.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                            // 全脂奶及奶制品
                            result[0] = Double.valueOf(lifeStyleQuestionAnswerBo.getAddvalue()) * 200 + "";
                            result[1] = dietaryFrequencyConstant.frequencyMap.get(lifeStyleQuestionAnswerBo
                                    .getFrequency());
                        }
                    }
            ...
            for (LifeStyleQuestionAnswerPojo lifeStyleQuestionAnswerBo : p901List) {
                if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getOptionId())) {
                    if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getAddvalue())
                            && StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getFrequency())) {
                        if (lifeStyleConstant.O90104.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                            result[0] = Double.valueOf(lifeStyleQuestionAnswerBo.getAddvalue()) * 25 + "";
                            result[1] = dietaryFrequencyConstant.frequencyMap.get(lifeStyleQuestionAnswerBo
                                    .getFrequency());
                        }
                    }
                ...
                if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getOptionId())) {
                    if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getAddvalue())) {
                        if (lifeStyleConstant.O90105.equals(lifeStyleQuestionAnswerBo.getOptionId())
                                && StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getFrequency())) {
                            // 鱼类
                            result[0] = Double.valueOf(lifeStyleQuestionAnswerBo.getAddvalue()) * 50 + "";
                            result[1] = dietaryFrequencyConstant.frequencyMap.get(lifeStyleQuestionAnswerBo
                                    .getFrequency());
                        }
                    }
            ...
            for (LifeStyleQuestionAnswerPojo lifeStyleQuestionAnswerBo : p901List) {
                if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getOptionId())) {
                    if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getAddvalue())
                            && StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getFrequency())) {
                        if (lifeStyleConstant.O90106.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                            result[0] = Double.valueOf(lifeStyleQuestionAnswerBo.getAddvalue()) * 10 + "";
                            result[1] = dietaryFrequencyConstant.frequencyMap.get(lifeStyleQuestionAnswerBo
                                    .getFrequency());
                        }
                    }
     ...
     * @return
     */
    public String[] getFre7() {
        String[] result = new String[] {"", ""};
        List<LifeStyleQuestionAnswerPojo> p901List = questionMap.get(lifeStyleConstant.p903);
        if (CollectionUtils.isNotEmpty(p901List)) {
            for (LifeStyleQuestionAnswerPojo lifeStyleQuestionAnswerBo : p901List) {
                if (lifeStyleConstant.O90302.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                    result[0] = lifeStyleQuestionAnswerBo.getAddvalue();
                    result[1] = dietaryFrequencyConstant.frequencyMap.get(lifeStyleQuestionAnswerBo
                            .getFrequency());
                }
            }
    ...
    public String[] getFre10() {
        String[] result = new String[] {"", ""};
        List<LifeStyleQuestionAnswerPojo> p901List = questionMap.get(lifeStyleConstant.p902);
        if (CollectionUtils.isNotEmpty(p901List)) {
            for (LifeStyleQuestionAnswerPojo lifeStyleQuestionAnswerBo : p901List) {
                if (lifeStyleConstant.O90201.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                    result[0] = lifeStyleQuestionAnswerBo.getAddvalue();
    ...
    public String getYingyang() {
        String result = "";
        List<LifeStyleQuestionAnswerPojo> tmpList = questionMap.get(dietaryFrequencyConstant.p111);
        if (CollectionUtils.isNotEmpty(tmpList)) {
            for (LifeStyleQuestionAnswerPojo lifeStyleQuestionAnswerBo : tmpList) {
                result = lifeStyleQuestionAnswerBo.getAddvalue();
            }
        }
        return result;
    }
                ...
                if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getOptionId())) {
                    if (StringUtils.isNotEmpty(lifeStyleQuestionAnswerBo.getAddvalue())) {
                        ...
                        if (lifeStyleConstant.O80112.equals(lifeStyleQuestionAnswerBo.getOptionId())) {
                            ...
                            ElementRatio ratio = new PizzaRatio();
                            if (lifeStyleQuestionAnswerBo.getAddvalue().matches("\\d+(.\\d{1,2})?")) {
                                result = result + (Double.parseDouble(lifeStyleQuestionAnswerBo.getAddvalue()) * ratio
                                        .getMeatRatio() * 16.5);
                            }
                        }
                    }
