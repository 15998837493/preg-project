 ...
 */
public class DietaryFrequencyConstant {

    private static DietaryFrequencyConstant lifeStyleConstant;
    ...
    // 频率对应关系
    public Map<String, String> frequencyMap;
    ...
    // =======================================报告部分使用===============================
    public String water = "dietary000001";// 饮水

    public String oils = "dietary000002";// 用油量

    public String cereal = "dietary000003";// 谷类

    public String potatoes = "dietary000004";// 薯类

    public String veg = "dietary000005";// 蔬菜

    public String fruit = "dietary000006";// 水果

    public String fme = "dietary000007";// 鱼肉蛋

    public String milk = "dietary000008";// 乳类

    public String bean = "dietary000009";// 大豆类

    public String nut = "dietary000010";// 坚果

    public String organs = "dietary000011";// 动物内脏

    public String fungus = "dietary000012";// 菌类

    public String algae = "dietary000013";// 藻类

    public String czl = "dietary000014";// 粗杂粮

    public String vegetables = "dietary000015";// 绿叶蔬菜

    public String goodProtid = "dietary000016";// 优质蛋白质

    public String meatRatio = "dietary000017";// 优质蛋白质

    public String actual_totalEnergy = "dietary000018";// 实际一日总能量

    public String putongEnergy = "dietary000019";// 普通食物能量占比

    public String zibuEnergy = "dietary000020";// 滋补食品能量占比

    public String lingshiEnergy = "dietary000021";// 零食能量占比

    public String cbr = "dietary000022";// 碳水化合物摄入量

    public String cbrratio = "dietary000023";// 碳水化合物供能比

    public String protid = "dietary000024";// 蛋白质摄入量

    public String protidratio = "dietary000025";// 蛋白质供能比

    public String fat = "dietary000026";// 脂肪摄入量

    public String fatratio = "dietary000027";// 脂肪供能比

    public String lacking = "dietary000028";// 膳食中可能不足的营养素

    // 以下命名序号和pdf对应
    public String fre1 = "dietary000029";// 全脂奶及奶制品

    public String fre2 = "dietary000030";// 脱脂奶及奶制品

    public String fre3 = "dietary000031";// 大豆类

    public String fre4 = "dietary000032";// 鱼虾贝类

    public String fre5 = "dietary000033";// 坚果

    public String fre6 = "dietary000034";// 动物内脏

    public String fre7 = "dietary000035";// 海参

    public String fre8 = "dietary000036";// 燕窝

    public String fre9 = "dietary000037";// 蜂蜜

    public String fre10 = "dietary000038";// 饼干

    public String fre11 = "dietary000039";// 蛋糕

    public String fre12 = "dietary000040";// 巧克力

    public String fre13 = "dietary000041";// 蜜饯

    public String fre14 = "dietary000042";// 糖果

    public String fre15 = "dietary000043";// 海苔

    public String fre16 = "dietary000044";// 膨化食品

    public String fre17 = "dietary000045";// 雪糕

    public String fre18 = "dietary000046";// 饮料

    public String yingYang = "dietary000047";// 特膳食品
    ...
    public String p904 = "p904";// 用油量

    public String p111 = "p111";// 营养食品
    ...
    public String O90401 = "O90401";// 每日用油小于10

    public String O90402 = "O90402";// 每日用油小于20

    public String O90403 = "O90403";// 每日用油约为25

    public String O90404 = "O90404";// 每日用油约为35

    public String O90405 = "O90405";// 每日用油大于40
    ...
    private DietaryFrequencyConstant() {
        ...
        frequencyMap.put("0", "不吃");
        frequencyMap.put("1", "1次/月");
        frequencyMap.put("2", "1~2次/月");
        frequencyMap.put("3", "2~3次/月");
        frequencyMap.put("4", "1~2次/周");
        frequencyMap.put("5", "3~4次/周");
        frequencyMap.put("6", "5~6次/周");
        frequencyMap.put("7", "1次/日");
        frequencyMap.put("8", "2次/日");
        frequencyMap.put("9", "3次/日及以上");
    };

    public static DietaryFrequencyConstant getInstance() {
        if (lifeStyleConstant == null) {
            lifeStyleConstant = new DietaryFrequencyConstant();
        }
