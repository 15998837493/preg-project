 ...
 */
public class PregIntakePojo implements Serializable {
    ...
    /** 膳食清单明细 */
    private List<PregIntakeDetailPojo> intakeDetailList;
    ...
    public List<PregIntakeDetailPojo> getIntakeDetailList() {
        return intakeDetailList;
    }

    public void setIntakeDetailList(List<PregIntakeDetailPojo> intakeDetailList) {
        this.intakeDetailList = intakeDetailList;
    }
}
