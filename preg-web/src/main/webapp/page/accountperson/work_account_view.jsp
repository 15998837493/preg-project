...
$(":input[name='diagnosisUser']").val("${userId}");
</script>
<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/accountperson/echarts_option.js"></script>
<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/accountperson/work_account_view.js"></script>
<body>
<!-- 工作量统计 -->
		...
		<div class="panel-group no-bottom" id="accordion">
			<div class="panel panel-default">
				...
				<div id="collapseOne" class="panel-collapse collapse">
					<form id="statisticDataPersonForm" name="statisticDataForm" action="${common.basepath }${applicationScope.URL.WorkAccount.STATISTICS_DATA_PERSON_QUERY}">
					...
					<table id="statisticDataPersonTable" class="table table-bordered table-hover" style="table-layout:fixed;">
						<thead>
							<tr class="active">
	...
	<div class="panel-body" style="padding: 0px;">
		...
		<div id="myTabContent" class="tab-content">
			<div class="tab-pane active" id="tab1">
				<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/accountperson/work_account_tab1_echart.js"></script>
				<div class="panel-body form-inline">
					<form id="tab1QueryForm" action="${common.basepath }${applicationScope.URL.WorkAccount.WORK_ACCOUNT_QUERY_TAB1}">
						...
						<input type="hidden" id='tab1DiagnosisUser' name="diagnosisUser"/>
			...
			<div class="tab-pane fade" id="tab3">
				<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/accountperson/work_account_tab3_echart.js"></script>
				<div class="panel-body form-inline">
					<form id="nutritionQueryForm" action="${common.basepath }${applicationScope.URL.WorkAccount.WORK_ACCOUNT_QUERY}">
						<input id="pregStartDate1" name="startDate" type="text" class="form-control"  placeholder='请选择开始日期' readonly="" /> 至 
     					<input id="pregEndDate1" name="endDate" type="text" class="form-control"  placeholder='请选择结束日期' readonly="" disabled="disabled" /> VS 
     					<input id="pregStartDate2" name="startDate2" type="text" class="form-control"  placeholder='请选择开始日期' readonly="" /> 至 
     					<input id="pregEndDate2" name="endDate2" type="text" class="form-control"  placeholder='请选择结束日期' readonly="" disabled="disabled"/>
						<button type="button" id="pregButton" name="creativeEchartBut" class="btn btn-default">
							生成图表
						</button>
					</form>
				</div>
				<!-- <div id="tab3Title" style="text-align: center;"><h1>初诊患者孕期分布</h1></div> -->
				<div  class="panel-body" id="tab3EchartLeft" style="border-top: 1px solid #ddd; display: none;">
					<div id='echartTableft' class='col-xs-6' style='height:300px;'></div>
					<div id='echartTabRight' class='col-xs-6' style='height:300px;'></div>
				</div>
			...
			<div class="tab-pane fade" id="tab4">
				<!-- 引入 echarts配置 -->
				<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/accountperson/work_account_tab4_echart.js"></script>
  				<div class="panel-body form-inline">
			...
			<div class="tab-pane fade" id="tab5">
				<!-- 引入 echarts配置 -->
				<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/accountperson/work_account_tab5_echart.js"></script>
  				<div class="panel-body form-inline">
			...
			<div class="tab-pane fade" id="tab6">
				<!-- 引入 echarts配置 -->
				<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/accountperson/work_account_tab6_echart.js"></script>
				<div class="panel-body form-inline">
  					...
  					<input type="hidden" id="allUser" name="diagnosisUser" />
			...
			<div class="tab-pane fade" id="tab7">
				<!-- 引入 echarts配置 -->
				<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/accountperson/work_account_tab7_echart.js"></script>
			</div>
		</div>
	</div>
</div>
