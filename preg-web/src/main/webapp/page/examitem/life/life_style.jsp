...
<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/examitem/life/life_style.js"></script>
<%@ include file="/page/examitem/life/life_style_model.jsp" %>
<script type="text/javascript">
$().ready(function(){
	questionnaire.init();
