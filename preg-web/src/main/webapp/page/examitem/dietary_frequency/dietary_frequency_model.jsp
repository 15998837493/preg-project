...
<script id="p5" type="text/html">
	...
	<div class="col-xs-3">
        <div class="thumbnail">
            <img src="${common.basepath}/{{question.options[i].imgUrl}}" alt="{{question.options[i].optionName}}" style="height:150px">
            <div class="caption">
...
var pid="";
	...
	<div class="col-xs-3">
        <div class="thumbnail">
            <img src="${common.basepath}/{{question.options[i+1].imgUrl}}" alt={{question.options[i+1].optionName}} style="height:150px">
            <div class="caption">
...
var pid="";
	...
	<div class="col-xs-3">
        <div class="thumbnail">
            <img src="${common.basepath}/{{question.options[i+2].imgUrl}}" alt={{question.options[i+2].optionName}} style="height:150px">
            <div class="caption">
...
var pid="";
	...
	<div class="col-xs-3">
        <div class="thumbnail">
            <img src="${common.basepath}/{{question.options[i+3].imgUrl}}" alt="{{question.options[i+3].optionName}}" style="height:150px">
            <div class="caption">
...
<script id="p8" type="text/html">
	...
	<div class="panel panel-primary">
    	...
    	<div class="panel-body">
				...
				<div class="col-xs-10 col-xs-offset-1">
					<img src="${common.basepath}/{{question.options[0].imgUrl}}" class="img-responsive" nolarge style="height:150px">
				</div>
    	</div>
	</div>
	<div class="panel panel-primary">
    	...
    	<div class="panel-body">
						...
						<div class="col-xs-12">
							{{#
								 ...
								 <div class="col-md-3">
									<div class="thumbnail">
										<img src="${common.basepath}/{{question.options[1].imgUrl[pic]}}" class="img-responsive" style="height:150px">
										<div class="caption">
    	...
    	<div class="panel-body">
					...
					<div class="col-xs-12">
						{{#
							 ...
							 <div class="col-md-3">
								<div class="thumbnail">
									<img src="${common.basepath}/{{question.options[3].imgUrl[pic]}}" class="img-responsive" style="height:150px">
									<div class="caption">
    	...
    	<div class="panel-body">
				...
				<div class="col-xs-12">
					{{#
						 ...
						 <div class="col-md-3">
							<div class="thumbnail">
								<img src="${common.basepath}/{{question.options[4].imgUrl[pic]}}" class="img-responsive" style="height:150px">
								<div class="caption">
    	...
    	<div class="panel-body">
					...
					<div class="col-xs-12">
						{{#
							 ...
							 <div class="col-md-3">
								<div class="thumbnail">
									<img src="${common.basepath}/{{question.options[5].imgUrl[pic]}}" class="img-responsive" style="height:150px">
									<div class="caption">
	...
	<div class="panel panel-primary">
    	...
    	<div class="panel-body">
			...
			<div class="col-xs-3 col-xs-offset-4">
				<img src="${common.basepath}/{{question.options[6].imgUrl}}" class="img-responsive" style="height:150px">
			</div>
    	</div>
	</div>
	</div>
...
<div class="col-xs-12 alert alert-danger">
	<h4>{{ questionnaire.problem.titleindex+1 }}、{{ contents[0]}}
		<input ptype="1" type="text"  class="underline" pid={{ question.problemId }} value={{answerContent}} ></input>
