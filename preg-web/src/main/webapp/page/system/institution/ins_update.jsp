...
<div class="container-fluid">
	<div class="row row-top">
		<form id="updateCompanyForm" name="updateCompanyForm" action="${common.basepath}/${applicationScope.URL.System.INS_UPDATE}" class="form-horizontal" method="post">
			<div class="col-xs-3 row-top no-right">
				<div class="form-group">
			        <div class="col-xs-6 col-xs-offset-6 no-right">
				        ...
				        <input type="hidden" id="insLogo" name="insLogo" value="${insVo.insLogo }"/>
			        </div>
              	</div>
			</div>
			...
			<div class="col-xs-10 col-xs-offset-1 border-top-blue row-top">
				<div class="col-xs-7 col-xs-offset-5">
                   	<div class="col-xs-3">
                   		<button class="btn btn-primary btn-block" type="submit"><i class="fa fa-save fa-fw"></i> 修改</button>
                   	</div>
                   	<div class="col-xs-3">
                       	<button class="btn btn-primary btn-block" type="button" onclick="cancelUpdate();">
                       		<i class="fa fa-share-square-o fa-fw"></i> 取消
                       	</button>
                    </div>
                </div>
			</div>
