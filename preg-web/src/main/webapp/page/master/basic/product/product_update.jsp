...
<script type="text/javascript"
	src="${common.basepath}/common/plugins/zTree/jquery.ztree.all-3.5.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
	...
	$().ready(
			function() {
				...
				selectNode = treeObj.getNodeByParam("id",
						"${productForm.productCategory}");
				if (selectNode != null) {
					treeObj.selectNode(selectNode, true);//指定选中ID的节点  
					treeObj.expandNode(selectNode, true, false);//指定选中ID节点展开   
				...
				$("#productUsageMethod").autocomplete(productUsageMethods,
						autoOption);
				$("#productPackageUnit").autocomplete(productPackageUnits,
						autoOption);
				$("#productStandard")
						.autocomplete(productStandards, autoOption);
			});
		...
		<div class="row row-top">
			<div class="panel panel-default">
				...
				<form id="updateForm" class="form-horizontal"
					action="${common.basepath}/${applicationScope.URL.Master.PRODUCT_UPDATE}"
					method="post">
					<div class="panel-body">
						<div class="col-xs-11">
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="productCategoryName" class="form-control"
										onclick="chooseMenuModal();" readonly placeholder="点击选择适合的分类"></input>
									<input id="productCategory" style="display:none;"
								...
								<div class="col-xs-4">
									<input id="productCode" name="productCode" class="form-control"
										value="${productForm.productCode}" readonly />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="productGoodsName" name="productGoodsName"
										class="form-control" value="${productForm.productGoodsName}" />
								</div>
								<label class="col-xs-2 control-label">通用名称</label>
								<div class="col-xs-4">
									<input id="productCommonName" name="productCommonName"
										class="form-control" value="${productForm.productCommonName}" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="productDosageDesc" name="productDosageDesc"
										class="form-control" value="${productForm.productDosageDesc}" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="productUsageMethod" name="productUsageMethod"
										class="form-control" value="${productForm.productUsageMethod}" />
								</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="productStandard" name="productStandard"
										class="form-control" value="${productForm.productStandard}" />
								</div>
								<label class="col-xs-2 control-label">整包单位</label>
								<div class="col-xs-4">
									<input id="productPackageUnit" name="productPackageUnit"
										class="form-control" value="${productForm.productPackageUnit}" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="productTreatment" name="productTreatment"
										class="form-control" value="${productForm.productTreatment}" />
								</div>
								<label class="col-xs-2 control-label">可用天数</label>
								<div class="col-xs-4">
									<div class="input-group">
										<input id="productDays" name="productDays"
											class="form-control" value="${productForm.productDays}" />
								...
								<div class="col-xs-4">
									<div class="input-group">
										<input id="productPurchasePrice"
											name="productPurchasePricestr" class="form-control"
											value="${productForm.productPurchasePricestr}" />
								...
								<div class="col-xs-4">
									<div class="input-group">
										<input id="productSellPrice" name="productSellPricestr"
											class="form-control"
											value="${productForm.productSellPricestr}" />
										<div class="input-group-addon">元</div>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="productBrand" name="productBrand"
										class="form-control" value="${productForm.productBrand}" />
								</div>
								<label class="col-xs-2 control-label">批准文号</label>
								<div class="col-xs-4">
									<input id="productLicense" name="productLicense"
										class="form-control" value="${productForm.productLicense}" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-10">
									<textarea id="productAllergy" name="productAllergy"
										class="form-control" maxlength="50">${productForm.productAllergy}</textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-10">
									<textarea id="productUsage" name="productUsage"
										class="form-control" maxlength="500">${productForm.productUsage}</textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-10">
									<textarea id="productUser" name="productUser"
										class="form-control" maxlength="500">${productForm.productUser}</textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-10">
									<textarea id="productMatters" name="productMatters"
										class="form-control" maxlength="100">${productForm.productMatters}</textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-10">
									<textarea id="productEffect" name="productEffect"
										class="form-control" maxlength="500">${productForm.productEffect}</textarea>
								</div>
							</div>
							<div class="form-group">
	...
	$().ready(
			function() {
				common.initCodeSelect("PRODUCTUNIT", "PRODUCTUNIT",
						"productUnit", "${productForm.productUnit}");
				common.initCodeSelect("PRODUCT_ATTRIBUTE", "PRODUCT_ATTRIBUTE",
						"productAttribute", "${productForm.productAttribute}");
				common.initCodeSelect("PRODUCTFREQUENCY", "PRODUCTFREQUENCY",
						"productFrequency", "${productForm.productFrequency}");
				common.initCodeSelect("TRUEORFALSE", "TRUEORFALSE","productIsOfficina",
						"${productForm.productIsOfficina}");
				common.initCodeSelect("TRUEORFALSE", "TRUEORFALSE",
						"productIsAssess", "${productForm.productIsAssess}");
				common.initCodeSelect("TRUEORFALSE", "TRUEORFALSE",
						"productIsEnergy", "${productForm.productIsEnergy}");
