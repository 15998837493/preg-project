...
var quotaOptions = {
	...
	columns: [
				...
				{"data":"inspectName","sClass":"text-left"},
				{"data": "inspectSex","sClass": "text-center",
					"render": function(data, type, row, meta) {
						return CODE.transCode("ITEMSEX",data);
					}
				},
				{"data": "inspectDesc","sClass": "text-center"}
	],
...
// 		  		{"data": "inspectCode","sClass": "text-center" },
				...
				{"data": "inspectCategory","sClass": "text-center",
					"render": function(data, type, row, meta) {
				...
				{"data": null,"sClass": "text-center",
					render:function(data,type,row,meta){
						return "<a onclick='addInspect(\""+data.inspectId+"\")' style='cursor: pointer;'><i class='fa fa-plus'></i>添加</a></td></tr>";
					}	
				}
		],
...
<script type="text/javascript" src="${common.basepath}/page/master/items/disease_inspect.js"></script>
</head>
<body>
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="panel panel-lightblue">
					<div class="panel-heading text-left"><i class="fa fa-search"></i>  诊断辅助检查配置<a class="close" data-dismiss="modal"><i class="fa fa-remove fa-fw"></i></a></div>
					<div  class="panel-body form-inline"  id="itemCondition">
                        <input id="inspectName" name="inspectName" class="form-control" type="text" placeholder="请输入项目名称" />
	                </div>
...
<div class="container-fluid">
	<div class="row row-top">
		...
		<div class="panel panel-default col-xs-9" >
			<div class="panel-heading">
				<i class="fa fa-list fa-fw"></i> 诊断辅助检查项目
			</div>
			<div class="row">
			<div class="panel-body" id="cust_div" style="height: auto !important;">			
	            <div id="quotaItemCondition" class="form-inline">
		            <form id="queryForm" action="${common.basepath }/${applicationScope.URL.item.QUERY_INSPECT}">
		                <input type="hidden" name="diseaseId" id="diseaseIdQuery"/>	
                        <input type='text' id='inspectNameConfig' name="inspectName" class='form-control' placeholder='请输入检索内容'/>
