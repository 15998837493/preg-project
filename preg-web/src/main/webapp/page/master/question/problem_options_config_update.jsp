            ...
            var choiceData={optionOrder:1,optionContent:"",optionSex:"all"};
              //添加行    
                ...
                function saveData(){
                	...
                	var url = URL.get("Question.UPDATE_PROBLEM");
                	//将表单序列化为json
              ...
              //初始化列表数据
                function initData(problemId){
            	  console.log(problemId);
                	 $.ajax({
                	       url: PublicConstant.basePath + URL.Question.QUERY_OPTION,
                ...
                <input class="form-control" type="hidden" name="problemId" id="id" value="${problem.problemId}"/>
                    ...
                    <div class="col-xs-12 border-top-blue row-top">
                        <div class="col-xs-8 col-xs-offset-3 ">
                            ...
                            <div class="col-xs-4">
                                <button class="btn btn-primary btn-block" type="button" onclick="redirectPage('query');"><i class='fa fa-share-square-o fa-fw'></i>返回</button>
                            </div>
                        </div>
                    </div>
            </div>
...
common.initCodeSelect("OPTIONVALIDATE","OPTIONVALIDATE","optionValidate","${problem.optionValidate}");
	 ...
	 validate=$("#updateForm").validate(intakeTemplateOptions);
    //加入必填项提示
