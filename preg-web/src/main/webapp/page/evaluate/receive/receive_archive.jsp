...
document.title = "孕期建档信息--"+opener.diagnosisJson.diagnosisCustName;
var pregnancyArchivesModel = {};
var codeMap=new Map();
...
$().ready(function() {
	pregnancyArchivesModel.openModel();
});

pregnancyArchivesModel.openModel = function(){
	var url = URL.get("Platform.DIAGNOSIS_ARCHIVE_GET");
	var params = "diagnosisId=" + opener.diagnosisJson.diagnosisId;
	ajax.post(url, params, dataType.json, function(data){
		var diagnosisData=data.value.customerVo;
		var arechives=data.value.pregArchivesVo;
		var diagnosisVo=data.value.diagnosisVo;
		...
		//给建档信息赋值
		if(!common.isEmpty(diagnosisVo)){
			$.each(diagnosisVo, function(key, val) {
				if(common.isEmpty(val)){
					val="无";
				}else if(unitMap.get(key)){
					val=val+unitMap.get(key);
				}
				$("#diagnosisVo_"+key).html(val);
			});	
		}
		
	});
	$("#diagnosis_diagnosisId").html(opener.diagnosisJson.diagnosisId);
};
</script>
<body>
                        ...
                        <div class="table-responsive">
                            <table summary=" 一、基本信息" class="table table-bordered">
                                <tr>
                                    ...
                                    <td class='text-left' id="diagnosisVo_diagnosisCustSikeId"></td>
                                ...
                                <tr>
                                    ...
                                    <td class='text-left' id="diagnosisVo_diagnosisCustWaistline"></td>
                                    ...
                                    <td class='text-left' id="arechives_createDateString"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
