...
<head>
    ...
    <script type="text/javascript" src="${common.basepath}/page/platform/platform_customer_view.js"></script>
    <style type="text/css">
        .label-checkbox {
            position: relative;
...
<div id="diagCustCondition">
    <form id="customerQuery" action="${common.basepath }/${applicationScope.URL.Platform.DIAGNOSIS_QUERY_MORE}" method="post" class="form-horizontal">
        <input type="hidden" name="diagnosisStatus" value="1"/>
    </form>
</div>
<table id="diagCustListTable" class="table table-bordered table-hover ">
    ...
    <tr class="active">
        ...
        <th class='text-center' style="display: none">门诊号</th>
        <th class='text-center' style="display: none">登记时间</th>
        ...
        <th class='text-center' style="width: 10%;">营养诊疗次数</th>
        <!-- <th class='text-center'>就诊来源</th> -->
...
<div class="panel-body" id="admissionsCondition">
    <form id="admissionsQuery" action="${common.basepath }/${applicationScope.URL.Platform.DIAGNOSIS_QUERY_MORE}" method="post" class="form-horizontal">
...
<table id="admissionsTable" class="table table-bordered table-hover">
    ...
    <tr class="active">
        <th class="text-center" style="width: 8%;">序号</th>
        <th class='text-center' style="display: none">接诊日期</th>
        <th class='text-center' style="display: none">门诊号</th>
        <th class='text-center' style="display: none">是否有接诊历史</th>
        <th class='text-center' style="width: 14%;">病案号</th>
        <th class='text-center' style="width: 14%;">ID</th>
...
<websocket userName="${wsUser }" ws="yes"></websocket>
</body>
</html>
