...
<script type="text/javascript" charset="utf-8" src="${common.basepath}/page/platform/tool/tool_disgnosis_summary.js"></script>
</head>
<body>
...
<div class="row" style="margin: 10px 0 10px 0;">
	...
	<div class="col-xs-11 mytitle-right"><i class="fa fa-tag fa-fw"></i>  <a name="clickUpdate" onclick="cli(1);">个人信息</a></div>
</div>
...
<div id="summary_abnormal_div" style="display: none;">
	<div class="row" style="margin: 10px 0 10px 0;">
		<div class="col-xs-1 mytitle-left"> </div>
		<div class="col-xs-11 mytitle-right"><i class="fa fa-tag fa-fw"></i> <a name="clickUpdate" onclick="cli(2);">辅助检查异常结果</a></div>
	</div>
</div>
...
<div class="row" style="margin: 10px 0 10px 0;">
	<div class="col-xs-1 mytitle-left"> </div>
	<div class="col-xs-11 mytitle-right"><i class="fa fa-tag fa-fw"></i> <a name="clickUpdate" name="clickUpdate" name="clickUpdate" onclick="cli(3);">营养处方</a></div>
</div>
<div class="panel panel-lightblue">
    <div class="table-responsive">
        <table class="table table-bordered table-padding-4">
            ...
            <tfoot id="extenderListTfoot" style="display:none;">
	            <tr>
	            	<td colspan="10" style="padding: 2px;" id="diagnosisExtenderDesc">
	            	</td>
	            </tr>
            </tfoot>
        </table>
...
<div class="row" style="margin: 10px 0 10px 0;">
	<div class="col-xs-1 mytitle-left"> </div>
	<div class="col-xs-11 mytitle-right"><i class="fa fa-tag fa-fw"></i> <a name="clickUpdate" onclick="cli(4);">膳食处方</a></div>
</div>
<div class="panel panel-lightblue">
    <div class="table-responsive">
...
<div class="row" style="margin: 10px 0 10px 0;">
	<div class="col-xs-1 mytitle-left"> </div>
	<div class="col-xs-11 mytitle-right"><i class="fa fa-tag fa-fw"></i> <a name="clickUpdate" onclick="cli(5);">复查与复诊预约</a></div>
</div>
<div class="panel panel-lightblue">
    <div class="table-responsive">
        <table class="table table-bordered">
...
<div class="row" style="margin: 10px 0 10px 0;">
	<div class="col-xs-1 mytitle-left"> </div>
	<div class="col-xs-11 mytitle-right"><i class="fa fa-tag fa-fw"></i> <a name="clickUpdate" onclick="cli(6);">课程预约</a></div>
</div>
<div class="panel panel-lightblue">
    <div class="table-responsive">
       	<table class="table table-bordered table-padding-4">
