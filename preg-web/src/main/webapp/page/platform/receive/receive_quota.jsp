...
<script type="text/javascript" src="${common.basepath}/page/platform/receive/receive_quota.js"></script>
</head>
<div class="panel panel-lightblue col-xs-12 no-left padding-zero" id="saveQuota_info_div">
	...
	<!-- 显示指标推断的诊断项目 -->
	<div class="panel-body col-xs-12" style="border-top: 1px solid #337ab7;" id="itemInferDiv" style="display: none">
	</div>
</div>
