 ...
 */
public class CliniclItemForm implements Serializable {
    ...
    /** 实际周数 */
    private String diagnosisFetusweek;

    /** 实际天数 */
    private String diagnosisFetusday;
    ...
    public String getDiagnosisBaby() {
        return diagnosisBaby;
    }

    public void setDiagnosisBaby(String diagnosisBaby) {
        this.diagnosisBaby = diagnosisBaby;
    }
    ...
    public String getDiagnosisFetusweek() {
        return diagnosisFetusweek;
    }

    public void setDiagnosisFetusweek(String diagnosisFetusweek) {
        this.diagnosisFetusweek = diagnosisFetusweek;
    }

    public String getDiagnosisFetusday() {
        return diagnosisFetusday;
    }

    public void setDiagnosisFetusday(String diagnosisFetusday) {
        this.diagnosisFetusday = diagnosisFetusday;
    }
